...
```
usuari@maquina:~$ docker-compose up -d calibre
```
...
```
usuari@maquina:~$ sudo apt-get update
usuari@maquina:~$ sudo apt-get install --no-install-recommends python3-lxml
```
