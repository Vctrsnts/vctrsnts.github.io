...
La actualización fue facil y sencilla, al estilo **Debian**, cambiar los `sources` que apuntan a **Wheezy** y hacer que apunten a **Jessie**. En principio no tendria que haber habido ningun problema, pero que equivocado estaba.

El fichero que se tiene que cambiar es:

```
usuari@maquina:~$ sudo vi /etc/apt/sources.list
```
...
En el proximo capitulo, explicare el proceso de instalación de **Jessie** en la Raspberry.
