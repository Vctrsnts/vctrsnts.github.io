---
layout: post
title: "Montar imagen ISO desde consola en GNU/Linux"
author: Victor
date: 2021-03-25
category: [linux]
---
...
```
usuari@maquina:~$ sudo mkdir /media/cdrom
```
...
```
usuari@maquina:~$ sudo mount -o loop -t iso9660 /ruta_imagen.iso /media/cdrom
```
...
```
usuari@maquina:~$ sudo umount /media/cdrom
```
