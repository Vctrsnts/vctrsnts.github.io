...
```
usuari@maquina:~$ cd /etc

usuari@maquina:~$ sudo cp jail.conf jail.local
```
...
```
usuari@maquina:~$ sudo /etc/init.d/fail2ban start
```

Y disfrutar de los baneos, que puedes ver, en el fichero de los :

```
/var/log/fail2ban.log
```

Que como dice un youtuber famoso <a href="https://www.youtube.com/channel/UCrBzBOMcUVV8ryyAU_c6P5g">PeladoNerd</a>, es un ejercicio muy saludable.
...
```
usuari@maquina:~$ fail2ban-client set sshd unbanip x.x.x.x
...
* [Desbanear IP](http://support.moonpoint.com/os/unix/linux/fail2ban-unban.php)
