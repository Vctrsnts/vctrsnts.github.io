---
layout: post
title: "Crear imagenes en docker"
author: Victor
date: 2020-12-14
category: [docker]
---
...
```
usuari@maquina:~$ docker build -t usuario/nombre_imagen:version .
```
...
```
usuari@maquina:~$ docker login
```

Una vez ya tenemos acceso procedemos a subir la imagen :

```
usuari@maquina:~$ docker push usuario/nombre_imagen:latest
```

Y ya tenemos  nuestra imagen de docker creada y subida en dockerhub.
